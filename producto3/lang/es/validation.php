...
return [
    ...
    | defecto usados por la clase validadora. Algunas de estas reglas
    | tienen múltiples versiones, como las reglas de tamaño. Siéntete
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'La :attribute proporcionada aparece en una filtración de datos. Por favor, elige una contraseña diferente.',
    ],
    ...
    'uploaded' => 'El archivo :attribute no se ha podido subir.',
    ...
    | atributos concretos usando la convención "attribute.rule".
    | Esto te permite especificar rápidamente un mensaje específico
    | para una combinación atributo-regla determinada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se usan para cambiar el placeholder
    | "attribute" por algo más legible, como "Correo electrónico"
