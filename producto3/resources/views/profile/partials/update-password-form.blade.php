<section class="mb-4">
    <header class="mb-3">
        ...
        <p class="small text-muted mb-0">{{ __('Asegúrate de utilizar una contraseña larga y difícil de adivinar.') }}
        </p>
    </header>
            ...
            <div class="col-12 col-lg-6">
                ...
                <div class="mb-3">
                    ...
                    <x-text-input id="update_password_current_password" name="current_password" type="password"
                        class="mt-1 w-100" autocomplete="current-password" />
            ...
            <div class="col-12 col-lg-6">
                ...
                <div class="mb-3">
                    ...
                    <x-text-input id="update_password_password_confirmation" name="password_confirmation"
                        type="password" class="mt-1 w-100" autocomplete="new-password" />
                </div>
            </div>
        </div>
        {{-- Botón actualizar + mensaje "Actualizado" --}}
