                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="id_hotel" name="id_hotel"
                                        ...
                                        @foreach ($hoteles as $hotel)
                                            <option value="{{ $hotel->id_hotel }}" {{ (string) old('id_hotel') === (string) $hotel->id_hotel ? 'selected' : '' }}>{{ $hotel->nombre }}</option>
                                        @endforeach
                                    </select>
                                    @error('id_hotel')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <select id="id_vehiculo" name="id_vehiculo"
                                            ...
                                            @foreach ($vehiculos as $vehiculo)
                                                <option value="{{ $vehiculo->id_vehiculo }}"
                                                    data-plazas="{{ $vehiculo->plazas }}" {{ (string) old('id_vehiculo') === (string) $vehiculo->id_vehiculo ? 'selected' : '' }}>
